...
const ProductModal: React.FC<ProductModalProps> = ({ shoe, isOpen, onOpenChange }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl w-full p-0 max-h-[90vh] grid grid-rows-[auto_1fr_auto] md:grid-rows-1 md:grid-cols-2">
        ...
        <div className="flex flex-col max-h-full">
          <DialogHeader className="text-left mb-4 p-6 md:p-8 pb-0">
          ...
          <ScrollArea className="h-full">
           ...
           <DialogFooter className="p-6 md:p-8 pt-4 mt-auto border-t">
